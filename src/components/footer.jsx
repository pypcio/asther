...
const Footer = () => {
  ...
  return (
    <footer className=" ph3 ph5-ns tc">
      <a className="link dim color-1 dib h2 w2 br-100 mr3 " href="#" title="">
      ...
      <a className="link dim color-1 dib br-100 h2 w2 mr3 " href="#" title="">
      ...
      <div className="mt2">
        ...
        <a href="#" className="f6 link dim color-1 dib">
          Terms
        </a>
      </div>
    </footer>
